...
function arraySort(arr) {
    ...
    arr.forEach(function (num, i) {
        ...
        // second statement finds the last element of similar element.
             ...
             * create a new array between similar elements and put it into first
             * index of similar ones
             */
            arr[i - counter] = arr.slice(i - counter, i + 1);
            // counter is 0 and ready to count new similar ones
            counter = 0;
        }
    });
...
// BONUS QUESTION
// Make it so it organizes strings differently
...
function arrSort(argument) {
    let arr2 = argument.filter(function (num, i) {
        return typeof argument[i] == "string";
    });

    let arr3 = argument.filter(function (num, i) {
        return typeof argument[i] == "number";
    });
